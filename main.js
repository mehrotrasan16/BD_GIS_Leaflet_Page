...
GRPCQuerier = {
    initialize: function () {
        ...
        this.service = new TargetedQueryServiceClient("http://localhost:9092");
        //this.service = new TargetedQueryServiceClient("http://lattice-164.cs.colostate.edu:9092");
        return this;
    },
...
},{"./targeted_query_service_grpc_web_pb.js":3,"./targeted_query_service_pb.js":4}],2:[function(require,module,exports){
//import grpc_querier from 'grpc_querier';
const {grpc_querier} = require('./grpc_querier.js');
...
Sketch_Visualizer = {
    ...
    userQueryTime: function(geohashList,startTime, endTime, map) {
        // const geohashList = [];
        // this._searchForIntersectingGeohashes(this._standardizeBounds(map.getBounds()),
        //     this._getBoundingGeohash(map.getBounds()), geohashList);
...
sketch_visualizer = function() {
    const sketchVisualizer = Sketch_Visualizer;
    sketchVisualizer.initialize();
...
try{
    ...
    console.log("sketch_viz error")
}
},{"./grpc_querier.js":1,"fs":6}],3:[function(require,module,exports){
/**
...
},{"./targeted_query_service_pb.js":4,"grpc-web":9}],4:[function(require,module,exports){
...
},{"google-protobuf":8}],5:[function(require,module,exports){
'use strict'
